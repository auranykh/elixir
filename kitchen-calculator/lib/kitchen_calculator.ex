defmodule KitchenCalculator do
  ...
  def from_milliliter(volume_pair, unit) when is_tuple(volume_pair) and tuple_size(volume_pair) == 2 and is_atom(unit) do
    case unit do
  ...
  def convert(volume_pair, unit) when is_tuple(volume_pair) and tuple_size(volume_pair) == 2 and is_atom(unit) do
